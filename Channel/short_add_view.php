            ...
            <div class="container-fluid">
               ...
               <br>
                 <div class="row">
                  ...
                  <?php
                                    $a=mysqli_query($con,"SELECT * FROM short_add WHERE ADD_ID='".$_SESSION['channel']."'");
                                    while($row=mysqli_fetch_row($a))
                                       {
                                          echo '
                                                            <div class="col-sm-3">
                                                         <div class="card iq-mb-3">
                                                         <img src="'.$row[1].'" class="card-img-top" alt="#" style="width:250px;height:250px">
                                                <div class="card-body">
                                                   
                                                   <a href="short_add_update.php?id='.$row[0].'">
                                                   ...
                                                   <a href="short_add_delete.php?id='.$row[0].'">
