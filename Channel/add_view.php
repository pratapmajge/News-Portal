            ...
            <div class="container-fluid">
               ...
               <br>
                 <div class="row">
                  ...
                  <?php
                        $a=mysqli_query($con,"SELECT * FROM add_upload WHERE ADD_ID='".$_SESSION['channel']."'");
                        while($row=mysqli_fetch_row($a))
                           {
                              echo '
                                                            <div class="col-sm-3">
                                                         <div class="card iq-mb-3">
                                                         <img src="'.$row[2].'" class="card-img-top" alt="#" style="width:250px;height:250px">
                                                <div class="card-body">
                                                   <h4 class="card-title">'.$row[1].'</h4>
                                                   <p class="card-text">'.$row[3].' </p>
                                                   <a href="add_update.php?id='.$row[0].'">
                                                   ...
                                                   <a href="add_delete.php?id='.$row[0].'">
