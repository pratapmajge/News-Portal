                         ...
                         <div class="iq-card" style="border-top: orange 3px solid;border-radius: 10px">
                           <div class="iq-card-header d-flex justify-content-between">
                              <div class="iq-header-title">
                                 <h4 class="card-title">Channel Banner</h4>
                              </div>
                           </div>
                           <div class="iq-card-body">
                              <form action="channel_banner.php" method="POST" enctype="multipart/form-data">
                                 <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                      ...
                                      <input type="file" class="form-control" required="true" id="validationDefault01" style="border-bottom: 1px solid gray;border-radius: 0px" name="image" >
                                    </div>
                                 </div>  
                          ...
                          <div class="table-responsive">
                             <table class="table">
                                ...
                                <tbody>
                                   ...
                                   <?php
                                   $a=mysqli_query($con,"SELECT * FROM channel_banner WHERE chbanner='".$_SESSION['channel']."'");
                                   while($row=mysqli_fetch_row($a))
                                      {
                                         echo '
                                            <tr>
                                               ...
                                               <td>'.$row[1].'</td>
                                               <td>
                                               <img src='.$row[2].' style="height:150px;width:150px">
                                            </td>
                                               ...
                                               <td>
                                               <a href="banner_delete.php?id='.$row[0].'">
...
{
    $name=$_POST['name'];
    $max1=mysqli_query($con,"select MAX(ID) from channel_banner");
$max=mysqli_fetch_row($max1);
      ...
      $file_exists=array("jpg","jpeg","png","gif","bmp","pdf");//file extenssions supported for upload 
        ...
        else
        {
            ...
            {
             $newname="$max_id"."_banner."."png";//name of file name to be saveds
        ...
        if (mysqli_query($con ,"INSERT INTO channel_banner VALUES('','".$name."','".$targetfile."','".$_SESSION['channel']."')")) {
            echo "
                <script>
