<?php
    ...
    $id=$_GET['id'];
    $rname=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM short_upload WHERE ID='".$id."'"));
session_start();
                     ...
                     <div class="iq-card" style="border-top: orange 3px solid;border-radius: 10px">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">Short-Add Update</h4>
                           </div>
                        </div>
                        <div class="iq-card-body">
                           <form method="POST" action="short_add.php?id=<?php echo $rname[0]?>" enctype="multipart/form-data">
                              <div class="form-row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input  type="text" class="form-control" id="validationDefault01" value="<?php echo $rname[3]?>" style="border-bottom: 1px solid gray;border-radius: 0px;height: 50px" name="desc">
                                 </div>
...
if (isset($_POST['save']))
{
    ...
    $id=$_POST['id'];
        ...
        if (mysqli_query($con ,"UPDATE short_add SET TITLE='".$name."',DESCRIPTION='".$desc."' WHERE ID='".$id."'")) {
            echo "
                <script>
        ...
        else
        {
            echo "
                <script>
                    alert ('TRY AGAIN..........!');
                    window.location.href='short_add_update.php';
                </script>
            ";
        }
      }
