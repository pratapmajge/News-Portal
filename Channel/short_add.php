                     ...
                     <div class="iq-card" style="border-top: orange 3px solid;border-radius: 10px">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title"> Add short Advertisement</h4>
                           </div>
                        </div>
                        <div class="iq-card-body">
                           <form method="POST" action="short_add.php" enctype="multipart/form-data">
                              <div class="form-row">
                                 
                                <div class="col-md-12 mb-3">
                                    <label for="validationDefault01">Add Image</label>
                                    <input type="file" name="image" class="form-control" id="validationDefault01" style="border-bottom: 1px solid black;border-radius: 0px">
                                 </div>
...
if (isset($_POST['save']))
{
    ...
    $max1=mysqli_query($con,"select MAX(ID) from short_add");
$max=mysqli_fetch_row($max1);
      ...
      $file_exists=array("jpg","jpeg","png","gif","bmp","pdf");//file extenssions supported for upload 
        ...
        else
        {
            ...
            {
             $newname="$max_id"."_short_add."."png";//name of file name to be saveds
        ...
        if (mysqli_query($con ,"INSERT INTO short_add  VALUES('','".$targetfile."','".$_SESSION['channel']."')")) {
            echo "
                <script>
                    alert ('SHORT ADD ADDED SUCCESSFULLY..........!');
                    window.location.href='short_add.php';
                </script>
            ";
            # code...
        }
