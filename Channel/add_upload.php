                           ...
                           <form method="POST" action="add_upload.php" enctype="multipart/form-data">
                              <div class="form-row">
                                 <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" name="name" autocomplete="off" required="true" class="form-control" id="validationDefault01" style="border-bottom: 1px solid black;border-radius: 0px">
                                 </div>
                                <div class="col-md-12 mb-3">
                                    <label for="validationDefault01">Add Image</label>
                                    <input type="file" name="image"  required="true" class="form-control" id="validationDefault01" style="border-bottom: 1px solid black;border-radius: 0px">
                                 </div>
                                <div class="col-md-12 mb-3">
                                    <label for="validationDefault01">Description</label>
                                    <textarea class="form-control" autocomplete="off" required="true" id="validationDefault01" style="border-bottom: 1px solid gray;border-radius: 0px;height: 50px" name="desc"></textarea>
                                 </div>
...
if (isset($_POST['save']))
{
    ...
    $max1=mysqli_query($con,"select MAX(ID) from add_upload");
$max=mysqli_fetch_row($max1);
      ...
      $file_exists=array("jpg","jpeg","png","gif","bmp","pdf");//file extenssions supported for upload 
        ...
        else
        {
            ...
            {
             $newname="$max_id"."_add."."png";//name of file name to be saveds
        ...
        if (mysqli_query($con ,"INSERT INTO add_upload  VALUES('','".$name."','".$targetfile."','".$desc."','".$_SESSION['channel']."')")) {
            echo "
                <script>
                    alert ('ADVERTISE ADDED SUCCESSFULLY..........!');
                    window.location.href='add_upload.php';
                </script>
            ";
            # code...
        }
