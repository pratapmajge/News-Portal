   ...
   <body>
      ...
      <div class="wrapper">
       ...
       ?>
        ...
        <form action="add_channel.php" enctype="multipart/form-data" method="POST" style="border-top: orange 3px solid;border-radius: 10px"><br>
        <div class="container">
           <div class="row">
                   <div class="col-sm-2"></div>
                   
                   <div class="col-sm-4">            
                        <input type="text" name="name" autocomplete="off" required="true" id="" placeholder="Enter Name" class="form-control" style="border-bottom: 1px solid rgb(193, 77, 206);border-radius: 10px; " > <br> <br>

                         <input type="file" name="image" required="true" id=""  class="form-control" style="border-bottom: 1px solid rgb(193, 77, 206);border-radius: 10px" > <br> <br>
                   ...
                   <div class="col-sm-4">
                        <input type="tel" name="mob" id="" placeholder="Enter Contact" autocomplete="off" required="true" class="form-control"  style="border-bottom: 1px solid rgb(193, 77, 206);border-radius: 10px; "> <br><br>
                        ...
                        <input type="password" name="password" autocomplete="off" required="true" id="" placeholder="Enter Password" class="form-control"  style="border-bottom: 1px solid rgb(193, 77, 206);border-radius: 10px; "><br><br>
...
$max=mysqli_fetch_row($max1);
   ...
   if(mysqli_query($con,"INSERT INTO add_channel VALUES('','".$name."','".$email."','".$date."','".$username."','".$charges."','".$contact."','".$adhar."','".$channel_name."','".$password."','".$education."','".$targetfile."','approved')"))
   {
      echo "
         <script>
            alert('Channel added successfully...!!');
            window.location.href='add_channel.php';
         </script>
      ";
   }
   else
