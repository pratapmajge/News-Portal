                    ...
                    <div class="row m-0">
                      <div class="col-md-6 bg-white sign-in-page-data">
                          <div class="sign-in-from" style="margin-top: 100px">
                              ...
                              <form class="mt-4" action="login2.php" method="POST">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input required="true" autocomplete="off" type="password" class="form-control mb-0" id="exampleInputEmail1" name="pass" placeholder="Enter Password">
                                  </div>
...
if(isset($_POST['login']))
{
    ...
    $res=mysqli_query($con,"SELECT * FROM add_channel WHERE USERNAME='".$uname."' && PASSWORD='".$pass."'");
    $row=mysqli_fetch_row($res);

   if($num=mysqli_num_rows($res)>0)
     {
     session_start();
     $_SESSION['channel']=$row[0];

    echo'
    <script>
   window.location.href="channel/index.php";
    </script>
    ';
    }
